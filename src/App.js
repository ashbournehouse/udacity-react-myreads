...
class BooksApp extends React.Component {
  state = {
    ...
    bookshelves: [
      {id: 1, location: "1", name: "Currently Reading"},
      {id: 2, location: "2", name: "Want to Read"},
      {id: 3, location: "3", name: "Read"},
      {id: 4, location: "4", name: "None"},
    ],
    allocations: [
      {shelf: 1, books: [1, 2]},
      {shelf: 2, books: [3, 4]},
  ...
  render() {
    const orderedShelfnames = this.state.bookshelves.map(bookshelf => bookshelf.name)
          ...
          <div className="content list-books">
            <div className="list-books-content">
              <div className="bookshelves">
                {orderedShelfnames.map((orderedShelfname) => (
                  <Bookshelf
                    shelfname={orderedShelfname}
                    books={[
